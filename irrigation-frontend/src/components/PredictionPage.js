...
const IconInfo = () => <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ width: 18, height: 18 }}><circle cx="12" cy="12" r="10"/><line x1="12" y1="16" x2="12" y2="12"/><line x1="12" y1="8" x2="12.01" y2="8"/></svg>;
      ...
      <div style={{ margin: '15px 0' }}>
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            <IconInfo />
            <span>Comprendre les paramètres</span>
          </div>
          <span style={{ opacity: 0.6 }}>{showInfo ? '▲' : '▼'}</span>
        </button>
          ...
          <div style={{
            ...
            <ul style={{ paddingLeft: '16px', margin: 0 }}>
              {Object.keys(EXPLANATIONS).map(key => (
                <li key={key} style={{ marginBottom: '7px' }}>
                  <strong style={{ color: '#fff' }}>{LABELS[key]} :</strong> {EXPLANATIONS[key]}
                </li>
              ))}
            </ul>
          </div>
